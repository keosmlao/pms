...
export default function AddPlanForm() {
  ...
  return (
    <form action={action} className="grid gap-2 sm:grid-cols-2 lg:grid-cols-[2fr_0.7fr_1.5fr_1fr_auto]">
      ...
      <input type="number" name="plan_qty" min={0} step="1" placeholder="ຈຳນວນ" className="min-h-9 rounded-lg border border-slate-200 bg-white px-3 text-sm text-slate-900 outline-none focus:border-teal-400 dark:border-slate-700 dark:bg-slate-950 dark:text-white" />
      ...
      <input type="date" name="target_date" className="min-h-9 rounded-lg border border-slate-200 bg-white px-2 text-sm text-slate-900 outline-none focus:border-teal-400 dark:border-slate-700 dark:bg-slate-950 dark:text-white" />
      <Btn />
