  ...
  return (
    <div className="w-full">
      ...
      <div className="mt-4 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
        ...
        {serials.length === 0 ? <p className="px-5 py-12 text-center text-sm text-slate-400">ບໍ່ພົບລາຍການ</p> : <div className="overflow-x-auto"><table className="w-full min-w-[1340px] text-sm">
